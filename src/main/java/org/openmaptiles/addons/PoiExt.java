...
public class PoiExt implements Layer, OpenMapTilesProfile.OsmAllProcessor {
  ...
  private Map<String, String> getTagToClassSubclassMap() {
    ...
    tagToClassSubclass.put("natural=hills", "natural,hills");
    tagToClassSubclass.put("natural=hill", "natural,hill");
    tagToClassSubclass.put("landuse=military", "landuse,military");
  ...
  private void addFeature(FeatureCollector features, String initialMethod, String clazz, String subclass,
